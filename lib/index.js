...
var CalendarHeader = (0, _createReactClass2.default)({
  ...
  propTypes: {
    ...
    previousButtonElement: _propTypes2.default.oneOfType([
      _propTypes2.default.string,
      _propTypes2.default.object,
    ]).isRequired,
    nextButtonElement: _propTypes2.default.oneOfType([
      _propTypes2.default.string,
      _propTypes2.default.object,
    ]).isRequired,
  },
...
var Calendar = (0, _createReactClass2.default)({
  ...
  render: function render() {
    ...
    for (var i = 0; i < 9; i++) {
      ...
      weeks.push(_react2.default.createElement("tr", { key: i }, week));
      if (day > monthLength) {
        break;
      }
    }
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement("tbody", null, weeks),
...
exports.default = (0, _createReactClass2.default)({
  ...
  propTypes: {
    ...
    weekStartsOnMonday: function weekStartsOnMonday(
      props,
      propName,
      componentName
    ) {
      if (props[propName]) {
        return new Error(
          "Prop '" +
            ...
            "' supplied to '" +
            componentName +
            "' is obsolete. Use 'weekStartsOn' instead."
        );
      }
    },
    weekStartsOn: _propTypes2.default.number,
    clearButtonElement: _propTypes2.default.oneOfType([
      _propTypes2.default.string,
      _propTypes2.default.object,
    ]),
    ...
    calendarPlacement: _propTypes2.default.oneOfType([
      _propTypes2.default.string,
  ...
  handleHide: function handleHide() {
    ...
    if (this.props.onBlur) {
      ...
      _reactDom2.default
        .findDOMNode(this.refs.hiddenInput)
        .dispatchEvent(event);
  ...
  render: function render() {
    ...
    var control = this.props.customControl
      ? _react2.default.cloneElement(this.props.customControl, {
      ...
      _react2.default.createElement(
        _Overlay2.default,
        {
          ...
          container: function container() {
            return (
              _this2.props.calendarContainer ||
              _reactDom2.default.findDOMNode(_this2.refs.overlayContainer)
            );
          },
